...
pub fn set_window_size(width: usize, height: usize) -> Result<(), String> {
    keygen_macos::set_window_size(width, height)
}

pub fn set_window_bounds(x: i32, y: i32, width: usize, height: usize) -> Result<(), String> {
    keygen_macos::set_window_bounds(x, y, width, height)
}

pub fn observe_window_frame() -> Result<keygen_macos::WindowFrame, String> {
    keygen_macos::observe_window_frame()
}
